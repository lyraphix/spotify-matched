    ...
    <Container>
      ...
      <AppBar position="fixed">
        ...
        >
          ...
          <Grid item xs={1}>
            <Button
              //style={{ minWidth: '1500px', minHeight: '40px' }}
              variant="text"
              size="medium"
              sx={{ flexGrow: 1, color: 'white' }}
              href="/posts/first-post"
            ...
            <Menu
              ...
              onClose={closeMenu}
            >
              <MenuItem onClick={closeMenu}><Link href="" underline="none" color="white">{'Profile'}</Link></MenuItem>
              <MenuItem onClick={closeMenu}><Link href="/" underline="none" color="white">{'Logout'}</Link></MenuItem>
            </Menu>
